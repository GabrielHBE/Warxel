...
public class InteractiveButtonUIIndicator : MonoBehaviour
{
    ...
    void Start() => interactKey.text = Settings.Instance._keybinds.PLAYER_interactKey.ToString();
    public void SetInteractiDesciption(string text) =>  interactDescription.text = text;   
}
