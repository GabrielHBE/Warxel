...
{
    public static PlayerLoadoutCustomization Instance { get; private set; }
    [Header("Camera")]
    ...
    private void Update()
    {
        ...
        {
            classesParent.gameObject.SetActive(true);
        }
        else
        {
            classesParent.gameObject.SetActive(false);
        }
    }
    ...
    public void SelectClass(ClassManager.Class @class)
    {
        ...
        class_description_text.text = "Class attributes:\n" + classManager.GetClassDescription(@class);
